...
export default function MarketingLayout({children}:{children:React.ReactNode}){
  return <div className="flex min-h-screen flex-col">
    ...
    <footer className="mt-auto border-t border-[#181818] bg-[#050505]">
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-12 text-sm text-sc-secondary md:grid-cols-[1.4fr_1fr_1fr_1fr]">
        <div>
          <Logo size={28}/>
        ...
        <div>
          <div className="text-xs font-semibold uppercase tracking-wider text-sc-muted">Platform</div>
          <div className="mt-4 grid gap-2.5">
            <Link href="/features" className="hover:text-white">Features</Link>
            <Link href="/features/storefront-builder" className="hover:text-white">Store builder</Link>
            <Link href="/features/digital-fulfillment" className="hover:text-white">Fulfillment</Link>
            <Link href="/features/analytics-insights" className="hover:text-white">Analytics</Link>
          </div>
        </div>

        <div>
          <div className="text-xs font-semibold uppercase tracking-wider text-sc-muted">Resources</div>
          <div className="mt-4 grid gap-2.5">
            <Link href="/docs" className="hover:text-white">Docs</Link>
            <Link href="/pricing" className="hover:text-white">Pricing</Link>
            <Link href="/features/developer-platform" className="hover:text-white">Developers</Link>
        ...
        <div>
          ...
          <div className="mt-4 grid gap-2.5">
            <Link href="/legal" className="hover:text-white">Legal overview</Link>
