...
const sections = [
  ...
  { id:"themes", icon:LayoutTemplate, title:"Themes & storefront", body:"Control how the storefront looks and behaves without changing commerce data. Build visual themes, keep draft changes private, publish when ready, or import supported ZIP and JSON theme packages.", points:["Official and merchant-created themes","Draft preview and explicit publishing","Visual homepage section builder","Colors, typography, layout and custom CSS","ZIP and JSON theme imports","Import conversion reports"] },
