...
const sections = [
  ...
  { id:"themes", icon:LayoutTemplate, title:"Themes & storefront", body:"Control how the storefront looks and behaves without changing commerce data.", points:["Theme gallery","Merchant-created themes","Visual page/section/block builder","Draft and publish workflow","Custom CSS and advanced code mode","Theme import pipeline for supported platforms"] },
